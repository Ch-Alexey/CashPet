# УСТАРЕЛО 25.09: источник правды — ./gradlew :content:simulate (движок на Kotlin по настоящим JSON).
# Таблицы обоих совпадают; этот файл оставлен как история расчёта экономики.
